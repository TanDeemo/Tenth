    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createtime', models.DateTimeField(auto_now_add=True, null=True, verbose_name='创建日期')),
                ('updatetime', models.DateTimeField(auto_now=True, null=True, verbose_name='修改日期')),
                ('article', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='headline.Article', verbose_name='问题ID')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subs', to='headline.Comment', verbose_name='父评论')),
        ...
        migrations.AddField(
            model_name='article',
            name='channel',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='articles', to='headline.Channel', verbose_name='所属频道'),
        ),
        migrations.AddField(
            model_name='article',
